...
Commits use the [commit format from angular](https://github.com/conventional-changelog-archived-repos/conventional-changelog-angular/blob/master/convention.mdconventional). Optionally you can create commits in the appropriate form by running:
