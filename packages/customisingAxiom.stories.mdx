...
import {CssVariableTable,CssColorVariableTable } from './themes';
...
`@brandwatch/axiom-materials` [exports](https://github.com/BrandwatchLtd/axiom-react/blob/master/packages/axiom-materials/src/importCssVariables.js) utility CSS variables which can be used to compose your own components 
or add spacing or other styles that are consistent with the Axiom designs. See the table below for a complete list of available CSS vars.
...
### CSS Variables
Click table row to copy css var declaration to clipboard.
